...
Route::get('depart', 'TacController@index')->name('index');
...
Route::get('/apercu', 'ProductController@packages')->name('basic-datas');
Route::get('/apercu/{cat}/{pin}', 'ProductController@packages')->name('basic-datas');

Route::get('/apercu/{cat}/{pin}/{pin2}', 'ProductController@detailPack')->name('basic-data');
...
//request 
Route::get('confirmer','UserdetailController@index')->name('choose');
//Route::get('apercu/{supplier}/{product}','ProductController@detailPack')->name('choose');
Route::get('confirmer/{supplier}/{product}',function(){
    
    return back();
    
    });
//Route::post('apercu/{supplier}/{product}/{dual}','ProductController@detailPack')->name('choose');

Route::get('confirmer/{supplier}/{product}/{dual}',function(){
