      ...
      if($Cuntotal==0){
       ...
       // $queryGas['category']=  $getParameters['parameters']['values']['comparison_type'];
        ...
        // active campaig updating
            ...
            $curUrl='https://comparateurenergie.tariefchecker.be/apercu/'.$products[0]['parameters']['values']['comparison_type'].'/'.$products[0]['parameters']['values']['dgo_id_electricity'].'-'.$products[0]['parameters']['values']['dgo_id_gas'].'-'.$products[0]['parameters']['values']['postal_code'].'?u='.$uuid;
