...
class ProductController extends Controller
{
   ...
   public function package(Request $request)
    {   
       ...
       // $query['meterType']='single';
        ...
        //  end-gas
                ...
                return redirect('apercu/'.$products[0]['parameters']['values']['comparison_type'].'/'.$products[0]['parameters']['values']['dgo_id_electricity'].'-'.$products[0]['parameters']['values']['dgo_id_gas'].'-'.$products[0]['parameters']['values']['postal_code'].'?u='.$uuid);
    ...
    {  
        ...
        //dd(getType((int)$get_product[0]['parameters']['values']['usage_gas']));
        ...
        //  $sorted = $products->sortBy(function ($item, $key) {
        //             return $item['price']['totals']['year']['excl_promo'];
        //         })->first();
    ...
    public function filter(Request $request){
        ...
        $feature = Feature::select('features.id','contract_details.part','contract_details.field', 'features.condition', 'features.NL_description', 'features.FR_description')
                           ...
                           ->get();
              if($totalProducts=='0'){
              $html.="<h3 class='not-fount'>Aucun fournisseur d'énergie n'a pu être trouvé avec les filtres que vous avez sélectionnés. Choisissez des filtres moins restrictifs pour pouvoir sélectionner des produits.</h3>";
              }
