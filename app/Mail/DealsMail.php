...
class DealsMail extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->view('mail.dealsmail', compact('postal','electricityDay','electricityNight','gas','productlist','parameters','actual_link'))->subject("Tariefchecker - Vous pouvez économiser jusqu'à 450 euro");
    }
}
