                                    ...
                                    <div class="col-md-5 col-sm-5">
                                        ...
                                        <div id="reg-form">
                                          ...
                                          @if(Session::get('url'))
                                           ...
                                           <input type="hidden" class="get_url" value="confirmer/{{$product['supplier']['name']}}/{{$product['product']['name']}}?type=dual&eid={{$eid}}&gid={{$gid}}&u=@if(isset($_COOKIE['uuid'])){{$_COOKIE['uuid']}}@endif">
                                          ...
                                          <input type="hidden" id="get_url" class="get_url" value="confirmer/{{$product['supplier']['name']}}/{{$product['product']['name']}}?u=@if(isset($_COOKIE['uuid'])){{$_COOKIE['uuid']}}@endif&type={{$product['parameters']['values']['comparison_type']}}&id={{$product['product']['_id']}}">
                                    ...
                                    <div class="col-md-5 col-sm-5">
                                        ...
                                        <input type="hidden" id='active-price' name="active-price" value="{{$prc}}">
                                         ...
                                         <input type="hidden" id='analytics_id' name="analytics_id" value="{{$_COOKIE['analytics_id']}}">
                                            ...
                                            <button class="req-btn-new ladda-button request-buttons loader"   id="" name="submit" value="@lang('home.Submit')" id="send">@lang('home.Submit')&nbsp; &nbsp;&nbsp; <span class="spinner-border" id="loading" style="display:none;"></span></button>
          ...
          $.ajax({
            url: '{{url('data-request')}}',
                    ...
                    if(url[1] && !url[2]){
                        ...
                        // $('.link-cmn').html('<a href="'+url[1]+'" target="_blank">Cliquez ici</a>');
                        return false;
                        ...
                        if(url[1] && url[2]){
                            ...
                            $('.link-one').html('<a href="'+url[1]+'" target="_blank">Cliquez ici</a>');
                            $('.link-two').html('<a href="'+url[2]+'" target="_blank">Cliquez ici</a>');
                        }
                        if(!url[1] && url[2]){
                            $('.linktwo').hide(); 
                            $('.linkone').hide();
                            $('.linkcmn').hide();
                             ...
                             // $('.link-cmn').html('<a href="'+url[2]+'" target="_blank">Cliquez ici</a>');
                             return false;
