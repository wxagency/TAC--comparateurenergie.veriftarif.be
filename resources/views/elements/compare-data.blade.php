...
@endif
										...
										<div>
											@if($discountss['parameters']['discount_type']=='servicelevel')
<p class="mode amt">Service digitalisé</p>
@elseif($discountss['parameters']['discount_type']=='loyalty')
<p class="mode amt">Réduction de loyauté</p>
@else
						...
						<div class="row">
                            ...
                            <!--discount-->
                                        ...
                                        @php
                                                ...
                                                @endforeach
							<div class="col-md-3 col-3">
								@if(($promo_discG+$promo_discE+$promo_discAll)>0)<p class="pricing-head-com">Réductions de bienvenue</p>@endif
								@if($sl_disc>0)<p class="pricing-head-com">Service digitalisé</p>@endif
								@if($loyalty_disc>0)<p class="pricing-head-com">Réduction de loyauté</p>@endif
							</div>
