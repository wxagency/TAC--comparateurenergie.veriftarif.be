...
@if(isset($_COOKIE['uuid']))
  ...
  @if(Session::get('locale')=='fr') 
    <div class="alert alert-warning alert-dismissible fade show text-center restoreSession" role="alert">
      ...
      <a href="https://{{$_SERVER['HTTP_HOST']}}/apercu/pack/IMEA-IMEA?&po=2000&u={{$_COOKIE['uuid']}}" type="button" class="btn btn-primary buttonYes">OUI</a>
...
@endif
   ...
   <div class="container">
    <div class="main-header-sec">
      ...
      @if(Session::get('locale')=='nl') 
        <img class="desktop" src="{{url('images/veriftarif.png')}}" alt="tariefchecker">
        <img class="mobile" src="{{url('images/veriftarif-mob.png')}}" alt="tariefchecker">
        @else
        <img class="desktop" src="{{url('images/veriftarif.png')}}" alt="tariefchecker">
        <img class="mobile" src="{{url('images/veriftarif-mob.png')}}" alt="tariefchecker">
        @endif
     ...
     <div class="front-sec-2">
        ...
        <form action="consumption-details" class="home_page_form" method="post">
          <div class="outer_sec_form">
            ...
            <div class="form-group">
              ...
              <p class="po-error-msg" style="color:red;display:none;" >Code postal invalide</p>
            <!-- <div id="sub-po" >-->
      ...
      <div class="right_content_home_form">
          <div class="image_home_sec">
            <img src="https://comparateurenergie.veriftarif.be/images/moskot01.png">
          </div>
      </div>
    </div>
