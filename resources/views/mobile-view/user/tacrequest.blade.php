                                ...
                                <div class="row">
                                    <div class="col-md-5 col-sm-5">
                                        ...
                                        <div id="reg-form">
                                          ...
                                          <input type="hidden" id="get_url" name="get_url" class="get_url" value="confirmer/{{$product['supplier']['name']}}/{{$product['product']['name']}}?u=@if(isset($_COOKIE['uuid'])){{$_COOKIE['uuid']}}@endif&type={{$product['parameters']['values']['comparison_type']}}&id={{$product['product']['_id']}}">
