    ...
    <div class="container">
        <div class="row">
			...
			<p>{{str_replace($replace2, $info2, $string2)}}</p>
                    ...
                    <ul>
                        <li><a href="https://www.veriftarif.be/conditions-generales-et-protection-des-donnees-personnelles">@lang('home.Terms_conditions')</a></li>
                        <li><a href="https://www.veriftarif.be/contact">@lang('home.Contact')</a></li>
                        <li><a href="https://www.veriftarif.be/energie/faq">@lang('home.Frequently_asked')</a></li>
