        ...
        init: function (options) {
            var p = {
                ...
                steps:[{									//Default step settings
                    ...
                    prevText:'Retourner',						//The text in the Prev Button
                ...
                lang: {										//Default language settings
                    ...
                    nextTextDefault:'Continuer',					//The text in the Next Button
                    prevTextDefault:'Retourner',					//The text in the Prev Button
                    endText:'Terminer',						//The text in the End Tour Button
			...
			if(typeof data == 'object'){	
				...
				$.iGuiderBtnAdd = function(){
					...
					$('<div>')
						...
						.html('<span style="font-size:11px">En savoir plus</span>')
						.appendTo('body');
				};
